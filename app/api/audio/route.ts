    ...
    await new Promise((resolve, reject) => {
      const ffmpeg = spawn('ffmpeg', [
        ...
        [
          ...
          '[voice_mixed]equalizer=f=250:t=h:w=1:g=-6,equalizer=f=1500:t=h:w=1:g=-4,equalizer=f=3000:t=h:w=1:g=-8,equalizer=f=7000:t=h:w=1.4:g=-20,volume=-14dB[voice_eq]',
